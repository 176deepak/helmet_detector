...
class DataValidation:
    def __init__(self, data_ingestion_artifact: DataIngestionArtifact = DataIngestionArtifact, data_validation_config: DataValidationConfig = DataValidationConfig):
        try:
    ...
    def initiate_data_validation(self) -> DataIngestionArtifact:
        ...
        try:
            ...
            logging.info("Exited initiate_data_validation method of DataValidation method of DataValidation class.")
            logging.info(f"Data validation artifact: {data_validation_artifact}") 
            if status:
                copy_tree(self.data_ingestion_artifact.extracted_data_path, os.getcwd()+"\data")
